...
| **CROP-001** | Crop Mode A (Exact Size) | PDF Sec 5.3 | CONFIRMED | Not Implemented | `services/image-engine` | Aspect/dimension assertions | Milestone 9 | Aspect ratio preserved |
